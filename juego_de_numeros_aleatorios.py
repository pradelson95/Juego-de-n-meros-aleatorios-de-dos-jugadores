...
if numerodejugador1>numerodejugador2:
    print(f"El ganador es {Nombredejugador1} porque su numero es el " + str(numerodejugador1) + " y el numero de su oponente es el {numerodejugador2}")

else:
    print(f"El ganador es {Nombredejugador2} porque su numero es el " + str(numerodejugador2) + " y el numero de su oponente es el {numerodejugador1}")
